...
def higher_card(card_one, card_two):
    ...
    elif num_card_one > num_card_two:
        return card_one
    else:
        return card_two
...
def value_of_ace(card_one, card_two):
    ...
    if num_card_one == 1 or num_card_two == 1:
        return 1
    else:
        if num_card_one + num_card_two <= 10:
            return 11
        else:
            return 1
...
def is_blackjack(card_one, card_two):
    ...
    num_card_one = 11 if card_one == 'A' else num_card_one
    num_card_two = 11 if card_two == 'A' else num_card_two

    return num_card_one + num_card_two == 21
...
def can_split_pairs(card_one, card_two):
   ...
   Returns:
    ...
    return num_card_one == num_card_two
...
def can_double_down(card_one, card_two):
    ...
    return 9 <= num_card_one + num_card_two <= 11
